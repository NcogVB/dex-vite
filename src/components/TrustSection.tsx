const TrustSection = () => (
    <section>
        <div className="w-full max-w-[1500px] mx-auto px-4 relative">
            ...
            <img
                className="absolute top-0 left-0 w-full h-full z-[-1] md:block hidden"
                src="./images/trust-in-our.svg"
                alt=""
            />
        </div>
    </section>
